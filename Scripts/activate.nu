...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\я у мамы программист\Проект ТП\graph_generator_tasks_1_15'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\я у мамы программист\Проект ТП\graph_generator_tasks_1_15\Scripts\deactivate.nu'
