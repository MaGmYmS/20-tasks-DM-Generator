...
class Graph:
    ...
    # graph = Graph(6, 2, 3)
    # tasks = graph.task_five(1000)
    # file_name = "5 задание, графы"
    # question_name = "Графы, задание 5"
    ...
    def task_seven(self, count_task):
        ...
        for _ in range(count_task):
            ...
            for j in range(6 - count_right_choices):
                ...
                incorrect_asnwers.append(list_edges)
            ...
            tmp = (task_text, right_answers,incorrect_asnwers)
            output_list.append(tmp)
